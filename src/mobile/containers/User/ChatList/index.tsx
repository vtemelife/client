...
const ChatList: React.SFC<any> = () => {
  ...
  const { data: chatsData, loading } = useGet({
    path: SERVER_URLS.CHAT_LIST.toPath({
  ...
  return (
    <div className="container-chat-list">
      ...
      <Header name={title} fixed={true}>
        ...
        <div>
          <Link to={CLIENT_URLS.USER.CHAT_CREATE.toPath()}>
      ...
      <div className="chat-list">
        {!loading && chats.length === 0 && (
          <Alert variant="warning">
            ...
            <div className="d-flex">
              <LinkContainer to={CLIENT_URLS.USER.CHAT_CREATE.toPath()}>
        ...
        >
          {(chat: any) => (
            <Link
              to={CLIENT_URLS.USER.CHAT_DETAIL.toPath({
                urlParams: {
                  chatPk: chat.pk
                }
              })}
