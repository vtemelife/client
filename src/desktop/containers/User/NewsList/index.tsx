...
class NewsList extends React.PureComponent<IProps> {
  ...
  public renderTitle = (getParams: any) => {
    return this.valueTitle(getParams.news_type);
  };
        ...
        <Card>
          <Card.Body>
            ...
            <Nav className="flex-column">
              <Nav.Link
                onClick={() =>
                  onChangeGetParams({ is_unread: "true", news_type: undefined })
                }
              >
          ...
          <Card.Body>
            ...
            <FormSelect
              ...
              value={
                getParams.news_type
                  ? {
                      value: getParams.news_type,
                      display: this.valueTitle(getParams.news_type)
                    }
                  : null
              }
              onChange={(target: any) =>
